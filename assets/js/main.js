...
$(document).ready(function() {
	...
	$(".subsection-link").click(function(e) {
		...
		if ($(".navigation-links").hasClass("mobile")) {
			$(".navigation-links").addClass("autohide");
		}
	...
	if (check) {
		$(".navigation-links").removeClass("hoverable");
		$(".navigation-links").addClass("autohide");
		$(".navigation-links").addClass("mobile");
	...
	$("#toggle-button").click(function() {
		$(".navigation-links").toggleClass("autohide", 100);
	});
